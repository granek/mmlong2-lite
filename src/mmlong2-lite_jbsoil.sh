...
NUM_THREADS=80
MEM_MB=600000
MEDAKA_MODEL="r941_e81_sup_g514" # Just guessing on the model, the paper doesn't say whether it is fast/hac/sup or guppy version
...
WORKDIR="/work/josh/joebrown_soil/mmlong_output"
